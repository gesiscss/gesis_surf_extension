...
export default class ContentScriptHandler {
  ...
  public async sendScroll(
    ...
    const scrollTime =
      scrollData.scrollTime instanceof Date ? scrollData.scrollTime.toISOString() : scrollData.scrollTime;
   ...
   * @returns Promise<void>
   */
  public async sendHTML(htmlData: HTMLSnapshot, domainInfo: DomainInfo): Promise<void> {
